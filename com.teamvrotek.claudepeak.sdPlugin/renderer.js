...
function renderButton(data) {
    const theme = COLOR_THEMES[data.colorTheme] || COLOR_THEMES.claude;
    ...
    const line1 = isPeak ? 'PEAK' : 'OFF';
    const line2 = isPeak ? 'TIME' : 'PEAK';

    // Circle + two-line label, centered as a group
    // Circle at left, text to the right, whole group centered horizontally
    const groupX = isPeak ? 16 : 14;
    const statusSvg = `<circle cx="${groupX}" cy="0" r="10.5" fill="${circleColor}"/>
    <text x="${groupX + 20}" y="-6" text-anchor="start"
          fill="#ffffff" font-weight="bold" font-size="20"
          font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif"
          >${escapeXml(line1)}</text>
    <text x="${groupX + 20}" y="14" text-anchor="start"
          fill="#ffffff" font-weight="bold" font-size="20"
          font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif"
  ...
  <defs>
    <radialGradient id="bg" cx="50%" cy="50%" r="69%">
  ...
  <g clip-path="url(#outer)">
    ...
    <text x="72" y="110" text-anchor="middle"
          fill="#ffffff" font-weight="bold" font-size="22"
          font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif"
          >${escapeXml(countdownStr)}</text>
  </g>
</svg>`;
...
export { renderButton, renderError, COLOR_THEMES };
